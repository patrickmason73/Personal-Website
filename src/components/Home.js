...
function Home() {
    ...
    return (
        <div>
            ...
            <p style={{width: "50%", float: "right", borderStyle: "solid", backgroundColor: "black", color: "white", padding: "10px", textAlign: 'center', fontSize: '140%', borderRadius: "25px"}}>I am a software engineer and a graduate of <b>Flatiron School</b>, with experience in JavaScript, React, Ruby on Rails, and SQL!</p>
